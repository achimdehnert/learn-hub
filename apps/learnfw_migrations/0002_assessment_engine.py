        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("likert", "Likert-Skala (1-N)"),
                            ("weighted_likert", "Gewichtete Likert-Skala"),
                            ("quiz", "Quiz (Richtig/Falsch)"),
                            ("survey", "Umfrage (kein Scoring)"),
                        ],
                        default="likert",
                        max_length=30,
                        verbose_name="Scoring-Strategie",
                    ),
                ),
                (
                    "scale_min",
                    models.PositiveSmallIntegerField(default=1, verbose_name="Skalenminimum"),
                ),
                (
                    "scale_max",
                    models.PositiveSmallIntegerField(default=4, verbose_name="Skalenmaximum"),
                ),
                (
                    "scale_labels",
                    models.JSONField(
                        default=list,
                        help_text='Schema: [{"value": 1, "label": "Trifft nicht zu"}, ...]',
                        verbose_name="Skalen-Labels",
                    ),
                ),
                (
                    "is_public",
                    models.BooleanField(
                        default=False, verbose_name="Öffentlich (anonym ohne Login)"
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0,
                        help_text="0 = kein Bestehen erforderlich. Wert in Prozent (0-100).",
                        verbose_name="Mindest-Prozentsatz zum Bestehen",
                    ),
                ),
                (
                    "certificate_enabled",
                    models.BooleanField(default=False, verbose_name="Zertifikat aktiviert"),
                ),
                (
                    "report_enabled",
                    models.BooleanField(default=True, verbose_name="Bericht aktiviert"),
                ),
                (
                    "reassessment_months",
                    models.PositiveSmallIntegerField(
                        default=6, verbose_name="Re-Assessment nach N Monaten"
                    ),
                ),
                (
                    "retention_days",
                    models.PositiveIntegerField(
                        default=730,
                        help_text="DSGVO: Standard 730 Tage (24 Monate).",
                        verbose_name="Aufbewahrungsfrist (Tage)",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="iil_learnfw.course",
                        verbose_name="Verknüpfter Kurs",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=1.0,
                        help_text="Wird von WeightedLikertScoring verwendet. Standard: 1.0",
                        max_digits=4,
                ...
                (
                    "sort_order",
                    models.PositiveSmallIntegerField(default=0, verbose_name="Sortierreihenfolge"),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="Aktiv")),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Erstellt am")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Aktualisiert am")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Idempotenter Seed-Key (z.B. 'strat_gov_q1'). Leer = text-basierte Deduplizierung.",
                        max_length=100,
                        verbose_name="Stabiler Schlüssel",
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1,
                        help_text="Wird bei Textänderungen inkrementiert. Historische Antworten bleiben zuordenbar.",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="iil_learnfw.assessmentdimension",
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Muss ein gültiger Hex-Farbcode sein (z. B. #1A2B3C).",
                                regex="^#[0-9A-Fa-f]{6}$",
                            )
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "threshold_below_pct",
                    models.PositiveSmallIntegerField(
                        help_text="Empfehlung aktiv wenn Dimensions-Score (%) unter diesem Wert liegt. 0-100.",
                        verbose_name="Schwellenwert (%)",
                    ),
                ),
                ("title", models.CharField(max_length=300, verbose_name="Titel")),
                ("description", models.TextField(verbose_name="Beschreibung")),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="recommended_by",
                        to="iil_learnfw.lesson",
                        verbose_name="Empfohlene Lektion",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text='Schema: {str(question.public_id): {"question_text": "...", "value": 3, "question_version": 1}}',
                        verbose_name="Antworten (Snapshot)",
                    ),
                ),
                (
                    "scores",
                    models.JSONField(
                        default=dict,
                        help_text='Schema: {dimension_key: {"score": "2.75", "pct": 58, "weight": "1.00"}}',
                        verbose_name="Dimensions-Scores",
                    ),
                ),
                (
                    "total_score",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=6, verbose_name="Gesamt-Rohscore"
                    ),
                ),
                (
                    "total_pct",
                    models.PositiveSmallIntegerField(
                        default=0, verbose_name="Gesamt-Prozent (0-100)"
                    ),
                ),
                (
                    "weakest_dimension",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Schwächste Dimension"
                    ),
                ),
                (
                    "strongest_dimension",
                    models.CharField(blank=True, max_length=50, verbose_name="Stärkste Dimension"),
                ),
                (
                    "started_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="Gestartet am"),
                ),
                (
                    "completed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Abgeschlossen am"),
                ),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Aktualisiert am")),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Aufbewahrung endet am"
                    ),
                ),
                (
                    "deleted_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="iil_learnfw.assessmentmaturitylevel",
                        verbose_name="Erreichter Reifegrad",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=list,
                        help_text="Snapshot zum Generierungszeitpunkt. Schema: [{dimension_key, gap_pct, title, description, priority, course_id, lesson_id, external_url}]",
                        verbose_name="Empfehlungs-Snapshot",
                    ),
                ),
                (
                    "pdf_file",
                    models.FileField(
                        blank=True, upload_to="assessments/reports/%Y/%m/", verbose_name="PDF-Datei"
                    ),
                ),
                (
                    "generated_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="Generiert am"),
                ),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Aktualisiert am")),
                (
                    "deleted_at",
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="report",
                        to="iil_learnfw.assessmentattempt",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="iil_learnfw.issuedcertificate",
                        verbose_name="Ausgestelltes Zertifikat",
                    ),
                ),
            ],
            options={
