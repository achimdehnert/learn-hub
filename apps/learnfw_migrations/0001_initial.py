    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "html_template",
                    models.TextField(
                        help_text="HTML template for WeasyPrint rendering. Available context: {{ user }}, {{ course }}, {{ issued_at }}."
                    ),
                ),
                (
                    "logo",
                    models.FileField(
                        blank=True, upload_to=iil_learnfw.models.course.tenant_upload_path
                    ),
                ),
                (
                    "signature_image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "passing_score",
                    models.PositiveIntegerField(default=80, help_text="Minimum score (%) to pass."),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        help_text="PDF or PPTX file.",
                        upload_to=iil_learnfw.models.course.tenant_upload_path,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "points",
                    models.IntegerField(help_text="Positive = award, negative = deduction."),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "max_attempts",
                    models.PositiveIntegerField(default=0, help_text="0 = unlimited attempts."),
                ),
                (
                    "time_limit_minutes",
                    models.PositiveIntegerField(
                        blank=True, help_text="Time limit in minutes (NULL = no limit).", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package_file",
                    models.FileField(upload_to=iil_learnfw.models.scorm.scorm_upload_path),
                ),
                (
                    "manifest",
                    models.JSONField(
                        blank=True, default=dict, help_text="Parsed imsmanifest.xml as JSON."
                    ),
                ),
                (
                    "entry_point",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="learnfw_enrollments",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="issued_certificates",
                        to="iil_learnfw.certificatetemplate",
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.DurationField(
                        blank=True, help_text="Total time spent in SCORM session.", null=True
                    ),
                ),
                (
                    "suspend_data",
                    models.TextField(
                        blank=True, help_text="SCORM suspend_data for session resume."
                    ),
                ),
